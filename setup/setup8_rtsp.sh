...
# laptop
python detect.py --source rtsp://engineer:anakperantau@192.168.0.26:8554/unicast --weights detect-pt/exp6/weights/best.pt --conf 0.7 --name wastedetection --exist-ok --nosave
######
sudo apt-get update
